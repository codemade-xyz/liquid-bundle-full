...
class Template
{
	...
	public function setCache($cache) {
		if (is_array($cache)) {
			if (isset($cache['cache']) && class_exists('\CodeMade\LiquidBundle\Liquid\Cache\\' . ucwords($cache['cache']))) {
				$classname = '\CodeMade\LiquidBundle\Liquid\Cache\\' . ucwords($cache['cache']);
	...
	public function render(array $assigns = array(), $filters = null, array $registers = array()) {
		...
		Liquid::setLocaleArray($locale->getLocales());
